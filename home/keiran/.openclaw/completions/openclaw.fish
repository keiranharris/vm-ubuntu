...
complete -c openclaw -n "__fish_seen_subcommand_from tab" -a "label" -d 'Assign a friendly label to a tab'
...
complete -c openclaw -n "__fish_seen_subcommand_from new" -l label -d 'Assign a friendly tab label'
complete -c openclaw -n "__fish_seen_subcommand_from open" -l label -d 'Assign a friendly tab label'
...
complete -c openclaw -n "__fish_seen_subcommand_from screenshot" -l labels -d 'Overlay role refs on the screenshot'
...
complete -c openclaw -n "__fish_seen_subcommand_from snapshot" -l urls -d 'Append discovered link URLs to AI snapshots'
...
complete -c openclaw -n "__fish_seen_subcommand_from click-coords" -l target-id -d 'CDP target id (or unique prefix)'
complete -c openclaw -n "__fish_seen_subcommand_from click-coords" -l double -d 'Double click'
complete -c openclaw -n "__fish_seen_subcommand_from click-coords" -l button -d 'Mouse button to use'
complete -c openclaw -n "__fish_seen_subcommand_from click-coords" -l delay-ms -d 'Delay between mouse down/up'
